...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#faf9f5] via-[#f4f7f2] to-[#e9f2e7] p-8 md:p-12 lg:p-16 border border-white/50 mb-12 flex flex-col lg:flex-row items-center justify-between gap-12 min-h-[70vh] animate-fade-in">
